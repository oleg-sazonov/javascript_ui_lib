...
-   [Использование](#использование)
    -   [core.js](#основной-модуль-corejs)
    -   [Accordion](#accordion-component)
    -   [Carousel](#🖼-carousel-component)
    -   [Modal](#🪟-modal-component)
-   [Модули](#модули)
    -   [actions.js](#🧩-модуль-actionsjs)
    -   [attributes.js](#🧬-модуль-attributesjs)
    -   [classes.js](#🧩-модуль-classesjs)
    -   [display.js](#🧩-модуль-displayjs)
    -   [effects.js](#🧩-модуль-effectsjs)
    -   [handlers.js](#🧩-модуль-handlersjs)
