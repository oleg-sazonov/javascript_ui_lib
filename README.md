...
-   [Использование](#использование)
    ...
    -   [Основной модуль (](#основной-модуль-corejs)[`core.js`](#основной-модуль-corejs)[)](#основной-модуль-corejs)
    -   [Accordion Component](#accordion-component)
    -   [🖼 Carousel Component](#🖼-carousel-component)
    -   [1. HTML-разметка (ручная)](#1-html-разметка-ручная)
    -   [2. Создание динамической карусели](#2-создание-динамической-карусели)
    -   [⚙️ Параметры (для ](#⚙️-параметры-для-createcarousel-и-carousel)[`createCarousel`](#⚙️-параметры-для-createcarousel-и-carousel)[ и ](#⚙️-параметры-для-createcarousel-и-carousel)[`carousel`](#⚙️-параметры-для-createcarousel-и-carousel)[)](#⚙️-параметры-для-createcarousel-и-carousel)
